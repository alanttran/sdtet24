...
const Home = () => {
  const Carousel = () => {
    ...
    const slides = [{ src: enigmatic }, { src: ricecake }, { src: yots }];
    ...
    return (
      <div className="carousel">
        ...
        <div className="controls">
          <a href="#" onClick={prevSlide} className="prev">
            Previous
          </a>
          <a href="#" onClick={nextSlide} className="next">
            Next
          </a>
        </div>
      </div>
  ...
  const Carousel1 = () => {
    const [currentIndex, setCurrentIndex] = useState(0);
    const slides1 = [{ src: enigmatic1 }, { src: ricecake1 }, { src: yots1 }];
    ...
    return (
      <div className="carousel1">
        ...
        <div className="controls1">
          <a href="#" onClick={prevSlide} className="prev1">
            Previous
          </a>
          <a href="#" onClick={nextSlide} className="next1">
            Next
          </a>
        </div>
      </div>
      ...
      <section className="newyear-section">
        <div className="newyear-container">
          <div className="p-container">
            <h1 className="newyear-head newyear h1-font">
              NEW YEAR, NEW BEGINNINGS
            </h1>
            <h2 className="newyear-sub newyear h2-font">
              Năm Mới, Sự Khởi Đầu Mới
            </h2>
            <p className="p1-font homep1">
              The Tet Festival, or Tết Nguyên Đán is the Vietnamese Lunar New
              Year celebration, celebrating spring’s arrival. It’s a time for
              families to reunite, pay respect to ancestors, and welcome the new
              year with traditions that reflect Vietnamese culture.
            </p>
            <p className="p1-font homep1">
              In 2025, the festival will celebrate the Year of the Snake,
              symbolizing good fortune and prosperity. In Vietnamese astrology,
              the Snake brings reflection and strategic planning. As such, Tet
              provides a meaningful opportunity for families to set new goals
              and embrace a fresh start.{" "}
            </p>
            <p className="p1-font homep1">
              May your year be filled with wealth and prosperity.{" "}
            </p>
          </div>
          <div className="lantern-container">
            <img
              src={lantern}
              alt="lantern and flower decoration"
              className="lantern"
            ></img>
          </div>
        </div>
      ...
      <section className="year-container">
        ...
        <div className="card-container">
          <img
            ...
            alt="Polaroid attached to clothes line. 2025"
          ></img>
          <img
            src={card2}
        ...
        <div className="card-container-responsive">
          <div className="card-container2">
            <img
              src={card1}
              className="card1-responsive card"
              alt="Polaroid attached to clothes line. 2025"
            ></img>
            <img
              src={card2}
              className="card2-responsive card"
              alt="Polaroid attached to clothes line. 2025"
            ></img>
          </div>
          ...
          <div className="card-container2">
            <img
              src={card3}
              className="card3-responsive card"
              alt="Polaroid attached to clothes line. 2025"
            ></img>
            <img
              src={card4}
              className="card4-responsive card"
              alt="Polaroid attached to clothes line. 2025"
            ></img>
          </div>
        </div>
