            ...
            <div className="justin-card headline-card">
              ...
              <div className="headline-left-card-content-container">
                ...
                <div className="headline-left-card2">
                  <img src={luubich} className="justin"></img>
                </div>
              </div>
            </div>
      ...
      <section className="ticket2-section">
        <div className="ticket2-img-container">
          <div className="ticket2-container">
            <h1 className="headline-header event-header">
              2025 EVENTS TBD
              <br />
              HERE ARE LAST YEAR'S EVENTS
            </h1>
            <img src={ticketline} className="ticketline"></img>
          </div>
          <div className="event-container">
            ...
            <div className="lion-dance-container">
              <div className="dragon-and-lion">
                ...
                <h3 className="event-h3">
                  Please check our <span>schedule</span> for the exact times.
                </h3>
                <img src={flower} className="flower-img"></img>
                <div className="lion-link-container">
                  <p className="lion-links">
                    <a
                      href="https://www.legendaryliondance.com/"
                      className="lion-linka dragon-linka"
                      target="_blank"
                    >
                      Legendary
                    </a>{" "}
                    /{" "}
                    <a
                      href="https://hoanghiemliondance.blogspot.com/"
                      className="lion-linka dragon-linka"
                      target="_blank"
                    >
                      Hoa Nghiêm
                    ...
                    /{" "}
                    <a
                      href="http://www.sdliondance.com/"
                      className="lion-linka dragon-linka"
                      target="_blank"
                    >
                      Southern Sea
                    </a>{" "}
                    /<br className="responsive-break" /> Chánh Kiến
                  </p>
                </div>
              </div>
              ...
              <div className="taiko-container">
                ...
                <div className="taiko-left-container">
                  <div>
                    ...
                    <h2 className="event-sub-h2">
                      <a
                        href="https://naruwantaiko.com/"
                        className="lion-linka"
                        target="_blank"
                      >
                        NARUWAN TAIKO
                      </a>
              ...
              <div className="three-performance-container">
                <div className="leatea-container">
                  <div className="leatea-left-container">
                    <h2 className="event-h2 event-h2-margin">
                      <a href="/" className="leatea-btn">
                        LEATEA
                      </a>
                    </h2>
            ...
            <div className="performance-banner-container">
              <h2 className="performance-banner banner-margin">
                PAST COMPETITIONS
              </h2>
            </div>
            <div className="competitions1-container">
              <div className="kidstalent-container">
                <div className="kidstalent-header-container">
                  <h2 className="event-h2 kidstalent-headerr">
                    KIDS GOT TALENT
                  </h2>
                </div>
              ...
              <div className="stepup-container border-container">
                <div className="stepup-left-container">
                  <h2 className="event-h2 event-h2-margin stepup-header">
                    STEP UP DANCE
                  </h2>
                  <h2 className="event-sub-h2 responsive">FRI FEB 16,</h2>
                  <h2 className="event-sub-h2 responsive">
                    8:30 PM - MAIN STAGE
                  </h2>
                  <h3 className="event-h3 letterspacing nonresponsive">
                    Who will become the best dance crew to take home $1000?
                  </h3>
                  <h3 className="event-h3 textalign stepup-margin1 nonresponsive">
                    FRI FEB 16,<br></br>9:00 PM - MAIN STAGE
                  </h3>
                </div>
            ...
            <div className="competitions2-container">
              ...
              <div className="stepup-container">
                <div className="dance-left-container">
                  ...
                  <h3 className="event-sub-h2 responsive">
                    FRI FEB 16,5:30 PM <br /> MAIN STAGE
                  </h3>
                  <h3 className="event-h3 letterspacing nonresponsive">
                    No sign-ups necessary!<br></br>1ST PLACE RECEIVES $400!
                  </h3>

                  <h3 className="event-h3 textalign stepup-margin2 nonresponsive">
                    FRI FEB 16,<br></br>5:30 PM - MAIN STAGE
                  </h3>
                </div>
                <div className="stepup-right-container">
            ...
            <div className="attractions-container">
              <div className="cultural-village-container">
                ...
                <h2 className="event-h2 kidstalent-header responsive">
                  CULTURAL VILLAGE
                </h2>
                <h2 className="event-sub-h2 cultural-h2">
                  Showcasing unique art and historical Vietnamese art
                  installations!
                </h2>
              ...
              <div className="attractions-right-container">
                <div className="carnival1-container">
                  <div className="carnival-left-container">
                    ...
                    <h3 className="event-h3 carnival-h3 nonresponsive">
                      Games and rides charged separately!
                    </h3>
                    <div className="carnival-date-container">
                      <h3 className="event-h3 textalign carnival-margin">
                        Please check our schedule{" "}
                        <br className="responsive-br"></br>for the closing
                        times!
                      </h3>
                    </div>
                  </div>
                  <div className="carnival-right-container">
                    <img
                      src={carnival}
                      className="carnival nonresponsive"
                    ></img>
                ...
                <div className="petting-container">
                  <div className="carnival-left-container">
                    ...
                    <div className="carnival-date-container">
                      <h3 className="event-h3 textalign carnival-margin">
                        SAT FEB 17, <br className="responsive-br"></br>CULTURAL
                        VILLAGE
                      </h3>
                    </div>
                  </div>
